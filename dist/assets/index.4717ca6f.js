var D=Object.defineProperty,W=Object.defineProperties;var Z=Object.getOwnPropertyDescriptors;var b=Object.getOwnPropertySymbols;var E=Object.prototype.hasOwnProperty,v=Object.prototype.propertyIsEnumerable;var M=(r,s,i)=>s in r?D(r,s,{enumerable:!0,configurable:!0,writable:!0,value:i}):r[s]=i,x=(r,s)=>{for(var i in s||(s={}))E.call(s,i)&&M(r,i,s[i]);if(b)for(var i of b(s))v.call(s,i)&&M(r,i,s[i]);return r},g=(r,s)=>W(r,Z(s));var z=(r,s)=>{var i={};for(var e in r)E.call(r,e)&&s.indexOf(e)<0&&(i[e]=r[e]);if(r!=null&&b)for(var e of b(r))s.indexOf(e)<0&&v.call(r,e)&&(i[e]=r[e]);return i};import{r as c,R as t,L as A,C as B,j as n,a as G,M as T}from"./vendor.fa1b2304.js";const P=function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))e(a);new MutationObserver(a=>{for(const l of a)if(l.type==="childList")for(const d of l.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&e(d)}).observe(document,{childList:!0,subtree:!0});function i(a){const l={};return a.integrity&&(l.integrity=a.integrity),a.referrerpolicy&&(l.referrerPolicy=a.referrerpolicy),a.crossorigin==="use-credentials"?l.credentials="include":a.crossorigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function e(a){if(a.ep)return;a.ep=!0;const l=i(a);fetch(a.href,l)}};P();const N=Date.now();function j(){const[r,s]=c.exports.useState(0);return c.exports.useEffect(()=>{let i=!0;const e=()=>{s((Date.now()-N)/1e3),i&&requestAnimationFrame(e)};return e(),()=>{i=!1}},[]),r}let S=0;function o({children:r}){const s=c.exports.useMemo(()=>(S+=1,`sn-${S}`),[]);return c.exports.createElement(c.exports.Fragment,null,c.exports.createElement("label",{htmlFor:s,className:"margin-toggle sidenote-number"}),c.exports.createElement("input",{type:"checkbox",id:s,className:"margin-toggle"}),c.exports.createElement("span",{className:"sidenote"},r))}function w({children:r,style:s={}}){return c.exports.createElement("figure",{style:x({borderTop:"1px solid darkgray",borderBottom:"1px solid darkgray",padding:"10px 0"},s)},r)}const f={"N\xE4her:in in Bangladesch":.29,"Mensch mit Mindestlohn in Deutschland":9.82,"durchschnittliche Arbeitnehmer:in in Deutschland":18.15,"Professor:in in Deutschland":38.69,"Elon Musk":16e5},C={"N\xE4her:in in Bangladesch":"N\xE4her:innen in Bangladesch","Mensch mit Mindestlohn in Deutschland":"Menschen mit deutschem Mindestlohn","durchschnittliche Arbeitnehmer:in in Deutschland":"durchschnittliche deutsche Arbeitnehmer:innen","Professor:in in Deutschland":"deutsche Profesor:innen","Elon Musk":"Elon Musk",Du:"x Du"};function m(r,s=0){const i=Math.ceil(-Math.log10(r));return isFinite(i)?r.toFixed(Math.max(s,i)).replace(".",","):0 .toFixed(s).replace(".",",")}function y(e){var a=e,{value:r,onChange:s}=a,i=z(a,["value","onChange"]);const[l,d]=c.exports.useState(null),h=c.exports.useRef(null);return c.exports.useEffect(()=>{h.current&&clearTimeout(h.current),h.current=setTimeout(()=>{d(null)},500)},[r]),t.createElement("input",g(x({},i),{type:"text",value:l!==null?l:r.toFixed(2).replace(".",","),onChange:u=>{const p=parseFloat(u.target.value.replace(",","."));console.log(u.target.value),p&&s(p),d(u.target.value)}}))}function O({wage:r,setWage:s}){const[i,e]=c.exports.useState(8),[a,l]=c.exports.useState(1/i),d={type:"radio",style:{display:"none"}},h={padding:"2px 8px",margin:5,borderRadius:5};return t.createElement(w,null,t.createElement("p",null,t.createElement(y,{style:{width:100},id:"wage",value:r*a*i,onChange:u=>s(u/(a*i))})," \u20AC",t.createElement("input",g(x({},d),{id:"hour",name:"timeBase",onClick:()=>l(1/i),checked:a==1/i})),t.createElement("label",{htmlFor:"hour",style:g(x({},h),{marginLeft:30})},"Pro Stunde"),t.createElement("input",g(x({},d),{id:"month",name:"timeBase",onClick:()=>l(21),checked:a==21})),t.createElement("label",{htmlFor:"month",style:h},"Pro Monat"),t.createElement("input",g(x({},d),{id:"year",name:"timeBase",onClick:()=>l(21*12),checked:a==21*12})),t.createElement("label",{htmlFor:"year",style:h},"Pro Jahr"),t.createElement("br",null),t.createElement("br",null),a!=1/i&&t.createElement(t.Fragment,null,t.createElement(t.Fragment,null,t.createElement(y,{id:"perWeek",value:i*5,style:{width:100},onChange:u=>e(u/5)}),t.createElement("label",{htmlFor:"perWeek"}," Stunden Pro Woche")),t.createElement("p",null,"Entspricht ",t.createElement("b",null,r.toFixed(2)," \u20AC/h")))))}function L({wage:r,target:s=1}){const[i,e]=c.exports.useState(null),a=j(),l=g(x({},f),{Du:r});return t.createElement(w,{style:{display:"flex",flexDirection:"column",alignItems:"center"}},t.createElement("button",{onClick:()=>e(a),style:{padding:"3px 8px",margin:"0 0 20px",flexGrow:0,background:"transparent",border:"1px solid",borderRadius:10,width:100}},i?"neu starten":"starten"),Object.entries(l).map(([d,h])=>{const u=i?a-i:0,p=h/60/60;let k=Math.min(p*u,s),F=k==s?s/p:u;return t.createElement("div",{key:d},d," (",m(k,2)," \u20AC in ",m(F),"s)",t.createElement(A,{percent:k/s*100}))}))}function R({wage:r}){const s=x({Du:r},f),[i,e]=c.exports.useState(null),[a,l]=c.exports.useState(1),d=j();return t.createElement(w,{style:{display:"flex",flexWrap:"wrap"}},Object.entries(s).map(([h,u])=>{const p=i?d-i:0;return t.createElement("div",{key:h,onClick:()=>{e(d),l(u)},style:{padding:10,margin:20,textAlign:"center",background:a==u?"#0002":"transparent",borderRadius:10,flexBasis:0}},t.createElement(B,{value:new Date(p*a/u*1e3+new Date("2020-01-01T11:00:00Z").valueOf())}),t.createElement("span",{style:{paddingTop:3,display:"inline-block"}},h))}))}function H({value:r}){const s={125e-9:e=>t.createElement("b",null,"(Entspricht dem Gewicht von ",m(e,1)," Haaren)"),6e-4:e=>t.createElement(t.Fragment,null,"(Entspricht dem Gewicht von ",m(e,1)," Fingern)"),.0084:e=>t.createElement(t.Fragment,null,"(Entspricht dem Gewicht von ",m(e,1)," H\xE4nden)"),.0197:e=>t.createElement(t.Fragment,null,"(Entspricht dem Gewicht von ",m(e,1)," F\xFC\xDFen)"),.187:e=>t.createElement(t.Fragment,null,"(Entspricht dem Gewicht von ",m(e,1)," Beinen)"),.5:()=>t.createElement(t.Fragment,null),24:e=>t.createElement(t.Fragment,null,"(ca. ",m(e,1)," Schulklassen)"),1e4:e=>t.createElement(t.Fragment,null,"(ca. ",m(e,1)," Fu\xDFballstadien)"),45773:e=>t.createElement(t.Fragment,null,"(ca. ",m(e,1),"x die Einwohnerzahl Marburgs)"),83628:e=>t.createElement(t.Fragment,null,"(ca. ",m(e,1),"x die Einwohnerzahl Gie\xDFens)"),99e4:e=>t.createElement(t.Fragment,null,"(",m(e,1),"x die Einwohnerzahl des Saarlandes)"),5513130:e=>t.createElement("b",null,"(ca. die Einwohnerzahl Finnlands)")},i=Object.keys(s).sort((e,a)=>parseFloat(a)-parseFloat(e));for(const e of i)if(parseFloat(e)<=r)return s[e](r/parseFloat(e));return t.createElement(t.Fragment,null)}function K({wage:r}){const s=x({Du:r},f),[i,e]=c.exports.useState(r);return t.createElement(w,{style:{display:"flex",flexWrap:"wrap"}},Object.entries(s).map(([a,l],d)=>{const h=i/l;return t.createElement(t.Fragment,null,t.createElement("div",{key:a,onClick:()=>{e(l)},style:{padding:5,margin:20,textAlign:"center",background:i==l?"#0002":"transparent",borderRadius:10,flexBasis:300,height:100,display:"flex",justifyContent:"center",alignItems:"center"}},t.createElement("span",{style:{paddingTop:3,display:"inline-block"}},m(h,0)," ",h==1?a:C[a]," ",t.createElement("br",null),t.createElement(H,{value:h}))),d!=Object.keys(s).length-1&&t.createElement("div",{key:d,style:{display:"flex",justifyContent:"center",alignItems:"center"}},"\u2259"))}))}function U(r={}){const{wrapper:s}=r.components||{};return s?n.exports.jsx(s,Object.assign({},r,{children:n.exports.jsx(i,{})})):i();function i(){const e=Object.assign({h1:"h1",p:"p",h2:"h2",em:"em",a:"a",strong:"strong"},r.components);return n.exports.jsxs(n.exports.Fragment,{children:[n.exports.jsx(e.h1,{children:"Zeit ist Geld"}),`
...
und zu vergleichen. Wie lange dauert es, 1\xA0\u20AC zu verdienen?`}),n.exports.jsx(e.p,{children:"Machen wir hierzu ein Gedankenexperiment: Wie lange dauert es f\xFCr verschiedene Menschen, einen Euro zu verdienen?"}),n.exports.jsx(L,{wage:r.wage,target:1}),n.exports.jsx(e.p,{children:"Wir sehen also, dass es je nach Einkommen unterschiedlich lange dauert, einen Geldbetrag zu \u201Eerarbeiten\u201C."})]}),`
...
`,n.exports.jsx(o,{children:"Praktisch keine."}),"."]}),n.exports.jsx(R,{wage:r.wage})]}),`
